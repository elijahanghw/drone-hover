...
class Hover:
    ...
    def compute_hover(self, verbose=False, tol=1e-5):
        ...
        self.static(verbose, tol)
        if self.static_success == False:
            self.spinning(verbose, tol)
        
            
    def static(self, verbose, tol):
